...
function renderHelp(): string {
  return [
    ...
    "Usage:",
    "",
    "  ./bin/codemem-agent install [--agent codex|cursor|claude-code] [--target-dir <project_dir>] [--skill-dir <dir>] [--lang zh|en]",
    "  ./bin/codemem-agent detect [--agent codex|cursor|claude-code] [--target-dir <project_dir>] [--skill-dir <dir>]",
    "  ./bin/codemem-agent export [--agent codex|cursor|claude-code|all] [--target-dir <output_dir>] [--version <version>] [--lang zh|en]",
    "",
    "Notes:",
    "",
